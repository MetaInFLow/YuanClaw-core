...
WORKSPACE_BOUNDARY_NOTE = (
    ...
    "do not retry with shell tricks or alternative tools, and ask the user "
    "how to proceed if the resource is genuinely required)"
)
...
def resolve_path(path: str | Path, workspace: str | Path | None = None, *, strict: bool = False) -> Path:
    """Resolve a path, interpreting relative paths against workspace when present."""
