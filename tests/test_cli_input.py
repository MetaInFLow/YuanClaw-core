...
def mock_prompt_session():
    ...
    with patch("yuanclaw.cli.commands._PROMPT_SESSION", mock_session), \
         patch("yuanclaw.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("yuanclaw.cli.commands.PromptSession") as MockSession, \
         patch("yuanclaw.cli.commands.FileHistory") as MockHistory, \
