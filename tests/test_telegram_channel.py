...
from yuanclaw.config.schema import TelegramConfig
...
async def test_start_uses_request_proxy_without_builder_proxy(monkeypatch) -> None:
    ...
    monkeypatch.setattr("yuanclaw.channels.telegram.HTTPXRequest", _FakeHTTPXRequest)
    monkeypatch.setattr(
        "yuanclaw.channels.telegram.Application",
